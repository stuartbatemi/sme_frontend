...
const INTRO: ChatMessage = {
  role: "bot",
  text: "Habari! I'm the Fursa assistant. Ask me about starting a business in Dar es Salaam, I can recommend ideas.",
}
...
export function ChatBotWidget({ onGetStarted }: { onGetStarted?: () => void }) {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end gap-3">
      {open && (
        <div className="flex h-95 w-75 flex-col overflow-hidden rounded-2xl border border-white/15 bg-neutral-900/90 shadow-2xl backdrop-blur-xl sm:w-85">
